      ...
      <div className="bg-[#66FFFF] p-4 rounded-xl border border-black">
        ...
        {staff.map((s, i) => (
          <div key={i} className="mb-6">
            ...
            {/* ✅ Reservation Type + City PER STAFF */}
            <div className="grid grid-cols-5 mb-2 gap-2">
              ...
              <input
                ...
                onChange={(e) =>
                  update(i, "reservation_type", e.target.value)
                }
                className="bg-[#fff] p-2 border border-black rounded-md"
              />
            ...
            <div className="flex gap-4">
              ...
              <div className="w-[230px]">
                ...
                <div className="flex gap-4 mt-2">
                  <label className="bg-yellow-400 px-5 py-1 text-sm cursor-pointer rounded-md border border-black">
                    Upload
                    <input
                      type="file"
                      className="hidden"
              ...
              {/* FORM */}
              <div className="w-[950px] space-y-1">
                ...
                <div className="grid grid-cols-[120px_1fr] gap-2">
                  ...
                  <div className="flex gap-2">
                    <input
                      ...
                      placeholder="Name"
                      className="bg-white px-3 py-1 border border-black rounded-md"
                    />
                    <input
                      value={s.lastName}
                      onChange={(e) =>
                ...
                {fields.map((field) => (
                  <div
                    key={field.key}
                    className="grid grid-cols-[120px_500px_90px_90px] gap-1"
                  >
                    <div className="bg-[#0c2d67] text-white px-3 py-1 border rounded-md">
                      {field.label}
                    </div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        update(i, field.key as any, e.target.value)
                      }
                      className="bg-white px-3 py-1 border rounded-md"
                    />

                    <button
                      onClick={() => toggleField(i, field.key, true)}
                      className={`border rounded-md ${
                        s.active_fields[field.key]
                          ? "bg-yellow-300"
                          : "bg-yellow-100"
                      }`}
                    >
                ...
                {/* LANDLINE */}
                <div className="grid grid-cols-[120px_500px_90px_90px] gap-1">
                  <div className="bg-[#0c2d67] text-white px-3 py-1 border rounded-md">
                    Landline
                  </div>
                  ...
                  <div className="flex border rounded-md overflow-hidden">
                    <input
                      value={s.landline}
                      onChange={(e) =>
                        update(i, "landline", e.target.value)
                      }
                    ...
                    <input
                      value={s.extension}
                      onChange={(e) =>
                        update(i, "extension", e.target.value)
                      }
                ...
                <div className="flex justify-center gap-3 mt-2">
                  <button
                    onClick={addStaff}
                    className="bg-yellow-400 px-4 py-1 rounded-md border"
                  >
                    Add
                  </button>
                  ...
                  <button
                    onClick={() => remove(i)}
                    className="bg-red-500 text-white px-4 py-1 rounded-md border"
                  >
                    Remove
                  </button>
                </div>
