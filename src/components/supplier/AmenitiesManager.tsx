...
//       {/* HEADER */}
//       <div>
//         <h2 className="text-3xl font-bold">Property Amenities</h2>
...
//               />
//               {/* This div acts as your custom large checkbox */}
//               <div className="w-7 h-7 border-2 border-gray-400 rounded-md peer-checked:bg-blue-600 peer-checked:border-blue-600 transition flex items-center justify-center">
//                 <svg
