...
export default function AdminPropertyDetails() {
  ...
  const bookingRows = safeParseRows(policiesData.booking_policy);
  const cancellationRows = safeParseRows(policiesData.cancellation_policy);

  const bookingRemarks = policiesData.child_policy || "";
  const cancellationRemarks = policiesData.pet_policy || "";
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-10 gap-y-6">
              ...
              <div>
                ...
                <p className="font-medium">
                  {supplier?.mobile?.trim() ? supplier.mobile : "-"}
                </p>
              </div>
              ...
              <div className="md:col-span-2">
                ...
                <p className="font-medium">{property.address1}</p>
          ...
          rooms.map((room) => {
            ...
            return (
              <Card key={room.id} className="p-6 space-y-4">
                ...
                <p>
                  Max Adults: {room.max_adults} | Max Children:{" "}
                  {room.max_children}
                </p>
                  ...
                  return (
                    <div key={plan} className="border rounded-lg p-4">
                      ...
                      {planRates.map((rate) => (
                        <div
                          key={rate.id}
                          className="text-sm mb-3 border-b pb-2"
                        >
                          {/* RATE TYPE + PRICE */}
                          <p>
  ...
  <Card className="p-6 space-y-6">
    ...
    <div>
      ...
      <ul className="list-disc pl-6 text-sm space-y-1">
        ...
        {activeTab === "policies" && (
          <div className="space-y-4">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              {/* BOOKING TABLE */}
              <div className="border-2 border-[#2f5297] rounded-xl overflow-hidden bg-[#dfe8f8]">
                <div className="grid grid-cols-[60%_40%]">
                  <div className="bg-[#3b5998] text-white text-center font-bold py-3 border-r-2 border-[#16346f]">
                    Booking Policy
                  </div>
                  <div className="bg-[#3b5998] text-white text-center font-bold py-3">
                    Amount
                  </div>
                </div>

                {bookingRows.length > 0 ? (
                  bookingRows.map((row: any, i: number) => (
                    <div
                      key={i}
                      className="grid grid-cols-[60%_40%] border-t border-gray-500"
                    >
                      <div className="p-3 border-r-2 border-[#16346f] text-sm">
                        {row.policy || "-"}
                      </div>

                      <div className="p-3 text-green-700 font-semibold text-sm">
                        {row.amount || "-"}
                      </div>
                    </div>
                  ))
              ...
              <div className="border-2 border-[#2f5297] rounded-xl overflow-hidden bg-[#dfe8f8]">
                <div className="grid grid-cols-[60%_40%]">
                  <div className="bg-[#b22222] text-white text-center font-bold py-3 border-r-2 border-[#16346f]">
                    Cancellation Policy
                  </div>
                  <div className="bg-[#b22222] text-white text-center font-bold py-3">
                    Charge
                  </div>
                </div>

                {cancellationRows.length > 0 ? (
                  cancellationRows.map((row: any, i: number) => (
                    <div
                      key={i}
                      className="grid grid-cols-[60%_40%] border-t border-gray-500"
                    >
                      ...
                      <div className="p-3 text-[#9b2108] font-semibold text-sm">
                        {row.charge || "-"}
                      </div>
                    </div>
                  ))
            ...
            <div className="grid md:grid-cols-2 gap-2">
              ...
              <div className="border-2 border-[#2f5297] rounded-xl overflow-hidden bg-[#ffe9e9]">
                ...
                <div className="p-4 text-sm leading-6 text-justify whitespace-pre-line h-[160px] overflow-y-auto">
                  {bookingRemarks || "-"}
                </div>
              </div>
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  {data.videos.map((v: any) => {
                    ...
                    return (
                      ...
                      >
                        {isYouTubeUrl(videoValue) ? (
                          <iframe
                            src={getYouTubeEmbedUrl(videoValue)}
        ...
        {activeTab === "financial" && (
          <Card className="p-6 space-y-6">
            <div>
              ...
              <p>
                24Hr Check-in: {data.checkin?.is_24hr_checkin ? "Yes" : "No"}
              </p>
            </div>
        ...
        {/* ================= TIMELINE ================= */}
        <Card className="p-6">
          <h2 className="font-semibold text-lg mb-6">Property Timeline</h2>

          <div className="flex gap-4">
            <div className="w-3 h-3 bg-primary rounded-full mt-2" />
            <div>
              <p className="font-semibold">Property Created</p>
              <p className="text-sm text-muted-foreground">
